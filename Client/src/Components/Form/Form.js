...
const Form = ({currentId,setCurrentId})=>{
   ...
   const [truckData,setTrucData] = useState({company:'',product:'',quantity:'',source:'',destination:''});
  ...
  useEffect(()=>{
   ...
   const handleSubmit = (e)=>{
    ...
    const clear = ()=>{
   setCurrentId(null);
   setTrucData({company:'',product:'',quantity:'',source:'',destination:''});
   }
...
console.log("TruckData",truckData);
    return (
        ...
        <TextField
            ...
            onChange={(e)=>setTrucData({...truckData,company:e.target.value})}
          />
           <TextField
            required={true}
            label="Product"
          ...
          <TextField
            ...
            onChange={(e)=>setTrucData({...truckData,source:e.target.value})}
          />
