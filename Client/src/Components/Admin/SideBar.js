  ...
  return (
    <>
      ...
      <Drawer
        className="Icons"
        width={360}
        title={user.result.name==="ADMIN"||user.result.name==="admin"?user.result.name:"Admin"}
        placement="left"
        closable={false}
        onClose={onClose}
        visible={visible}
      >
        {user?(
         ...
         <Avatar className="Icons"alt={user.result.name==="ADMIN"||user.result.name==="admin"?user.result.name:"Admin"} src="cargo Transport">
           {user.result.name==="ADMIN"||user.result.name==="admin"?user.result.name.charAt(0):"A"}
           </Avatar>
         <div className="mt-5">
         <Typography className="Icons" variant="h6">{user.result.name==="ADMIN"||user.result.name==="admin"?user.result.name:'Admin'}</Typography>
          </div>
          <div className="mt-5">
